...
export default async function MainGate() {
  ...
  return (
    ...
    >
      ...
      <div
        aria-hidden
        className="gate-aurora pointer-events-none absolute inset-0 [background:radial-gradient(65%_45%_at_50%_-5%,rgba(15,118,110,0.08),transparent_70%),radial-gradient(45%_45%_at_100%_100%,rgba(138,95,20,0.1),transparent_70%)] dark:[background:radial-gradient(65%_45%_at_50%_-5%,rgba(78,195,234,0.16),transparent_70%),radial-gradient(45%_45%_at_100%_100%,rgba(223,180,105,0.12),transparent_70%)]"
      />
      <div
        aria-hidden
        className="pointer-events-none absolute inset-0 opacity-[0.16] [background-image:radial-gradient(rgba(27,24,21,0.45)_1px,transparent_1px)] [background-size:44px_44px] dark:opacity-[0.18] dark:[background-image:radial-gradient(rgba(148,172,214,0.55)_1px,transparent_1px)]"
      />
